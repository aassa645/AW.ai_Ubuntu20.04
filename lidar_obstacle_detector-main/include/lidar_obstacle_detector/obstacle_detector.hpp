...
//  typename pcl::PointCloud<PointT>::Ptr roof_out(new pcl::PointCloud<PointT>);
  pcl::CropBox<PointT> roof(true);
  roof.setMin(Eigen::Vector4f(-5, -2, -2, 1));
  roof.setMax(Eigen::Vector4f(5, 2, 2, 1));
  roof.setInputCloud(cloud_roi);
//  roof.setNegative(true);
////  roof.setNegative(false);
  roof.filter(indices);
//  roof.filter(*roof_out);
...
//  copyPointCloud (*cloud , *cloud_trans);
//
//  pcl::gpu::Octree::PointCloud cloud_device;
//  cloud_device.upload(cloud_trans->points);
//
